...
public enum WeaponCategory implements StringRepresentable {
	 ...
	 *
	 * <p>Endlag 10 against a zombie's 17 tick attack cycle: a claymore swing commits
	 * you for well over half a cycle, so a zombie that begins its wind-up on your
	 * swing frame lands its hit while you are still recovering. That punishment is
	 * the whole point of the category. Expect to move this number twice, not once.
	 *
	 ...
	 * ranged slice has somewhere to land. Today it only sets the endlag for bashing
