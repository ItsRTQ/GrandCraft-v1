...
/**
 * Points GeckoLib at the cobble golem's Blockbench files.
 *
 ...
 */
public class CobbleGolemModel extends GeoModel<CobbleGolemEntity> {
	private static final Identifier MODEL = GrandCraft.id("cobble_golem");
	private static final Identifier TEXTURE = GrandCraft.id("textures/entity/cobble_golem.png");
	private static final Identifier ANIMATIONS = GrandCraft.id("cobble_golem");
	...
	@Override
	public Identifier getAnimationResource(CobbleGolemEntity animatable) {
		return ANIMATIONS;
	}
}
